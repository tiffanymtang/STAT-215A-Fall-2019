...
# For a normal mixture model with two components, try implementing the EM algorithm from scratch by iterating between the E and M steps, for which we derived formulas for in class.
